...
// keep
// let knotProfile = originalSpawnedPointerBelongings.knotRelativeSizeAtFront / originalSpawnedPointerBelongings.knotAtProfile / 2
// let increaserProfile = knotProfile / originalSpawnedPointerBelongings.knotRelativeSizeAtFront
...
// keep !
spawnedPointerBelongings = draftFabrikk.spawnPointerBelongingsAtRectangle(/* keep */ /* y, x, z */ spawnedPointerBelongings.y - originalSpawnedPointerBelongings.knotAtProfile, spawnedPointerBelongings.x, debPointer, /* radius, d, f, frontRatio */ radius, 0.9, 0.4, 1, /* keep */ /* debthScaleRatio, frontScaleRatio, profileScaleRatio */ 1 * 4 * 1.2 * increaserDe, 1 * 4 * 1.7 * 1.2/* is it gorgylya? */ /* throughX */ * increaser, 1 * 2 * 1.7)
}
// keep !
...
let constructIncreaserPointerFromPointerBelongingsFromFront = function (knotWiFromBottomStatement, /* keep */ knotFromBottomStatement) {
    ...
    // keep throughX
    for(fromTry = 1; fromTry < iterationCountAtDe; fromTry++) {
        // keep

        if((/* keep spawnedPointerBelongingsFromBottomStatement.y + */ fromTry * knotDe) < (/* keep spawnedPointerBelongingsFromBottomStatement.x + */ originalSpawnedPointerBelongings.yTopRight - originalSpawnedPointerBelongings.yBottomRight) && spawnedPointerBelongingsFromBottomStatement.y + (originalSpawnedPointerBelongings.yTopRight - originalSpawnedPointerBelongings.yBottomRight) < (/* keep spawnedPointerBelongingsFromBottomStatement.x + *//* keep knotWi * fromTry */ + (knotDe * (fromTry + 1)))) {
            throughY = spawnedPointerBelongingsFromBottomStatement.y + fromTry * knotDe
            // keep
            fromTry++
            break
        }
    ...
    increaser = (originalSpawnedPointerBelongings.yStarting - originalSpawnedPointerBelongings.yTopLeftClosing + knotDe) / originalSpawnedPointerBelongings.knotRelativeSizeAtDebth * ((1 * 4 * 2) / (1 /* keep * 2 */ * 0.7))
    
    let constructedPointerBelongingsFromFront = {
        increaser
    }
    // keep
    return constructedPointerBelongingsFromFront
    // keep !
}

let constructIncreaserPointerFromPointerBelongingsFromProfile = function (knotWiFromBottomStatement, /* keep */ knotFromBottomStatement) {

    
    knotWi = originalSpawnedPointerBelongings.knotRelativeSizeAtFront / originalSpawnedPointerBelongings.knotAtDistanceX / 2
    let iterationCount = originalSpawnedPointerBelongings.knotRelativeSizeAtFront / knotWi
    ...
    for(fromTry = 1; fromTry < iterationCount; fromTry++) {
        ...
        if((/* keep spawnedPointerBelongingsFromBottomStatement.x + */ fromTry * knotWi) < (/* keep spawnedPointerBelongingsFromBottomStatement.x + */ originalSpawnedPointerBelongings.xBottomRight - originalSpawnedPointerBelongings.xStarting) && spawnedPointerBelongingsFromBottomStatement.x + (originalSpawnedPointerBelongings.xBottomRight - originalSpawnedPointerBelongings.xStarting) < (/* keep spawnedPointerBelongingsFromBottomStatement.x + *//* keep knotWi * fromTry */ + (knotWi * (fromTry + 1)))) {
            throughX = spawnedPointerBelongingsFromBottomStatement.x + fromTry * knotWi
            // keep
            fromTry++
            break
    ...
    increaser = (originalSpawnedPointerBelongings.xBottomRight - originalSpawnedPointerBelongings.xStarting + knotWi) / originalSpawnedPointerBelongings.knotRelativeSizeAtFront * ((1 * 4 * 2, 1, 1 * 4 * 1.7) / (1 * 2))
    
    let constructedPointerBelongingsFromProfile = {
        increaser
    }
    // keep
    return constructedPointerBelongingsFromProfile
    // keep !
}
let constructIncreaserPointerFromPointerBelongingsFromProfileOriginal = function (knotWiFromBottomStatement, /* keep */ knotFromBottomStatement) {
    ...
    for(fromTry = 1; fromTry < iterationCount; fromTry++) {
        ...
        if((/* keep spawnedPointerBelongingsFromBottomStatement.x + */ fromTry * knotWi) < (/* keep spawnedPointerBelongingsFromBottomStatement.x + */ originalSpawnedPointerBelongings.xClosing - originalSpawnedPointerBelongings.xStarting) && spawnedPointerBelongingsFromBottomStatement.x + (originalSpawnedPointerBelongings.xClosing - originalSpawnedPointerBelongings.xStarting) < (/* keep spawnedPointerBelongingsFromBottomStatement.x + *//* keep knotWi * fromTry */ + (knotWi * (fromTry + 1)))) {
            throughX = spawnedPointerBelongingsFromBottomStatement.x + fromTry * knotWi
            // keep
            fromTry++
            break
    ...
    increaser = (originalSpawnedPointerBelongings.xClosing - originalSpawnedPointerBelongings.xStarting + knotWi) / originalSpawnedPointerBelongings.knotRelativeSizeAtFront * ((1 * 4 * 2, 1, 1 * 4 * 1.7) / (1 * 2))
...
// yStarting, xStarting
// yClosing, xClosing
let constructedIncreaserPointerFromFront = constructIncreaserPointerFromPointerBelongingsFromFront(knotWi, originalSpawnedPointerBelongings)

let constructedIncreaserPointer = constructIncreaserPointerFromPointerBelongingsFromProfile(knotWi, originalSpawnedPointerBelongings)

// keep
let knot1 = draftFabrikk.constructKnot(/* keep */ /* let me use bounced memory */ /* y, x, z */ Math.random() * 0.5, Math.random() * 0.5, Math.random() * 0.2, radius, 0.9, 0.4, 1, /* keep */ 1 * constructedIncreaserPointerFromFront.increaser /*  keep */, 1 /* keep */, 1 * /* keep */ 2 * constructedIncreaserPointer.increaser)
